...
namespace GBC_WebService.EF
{
    ...
    public partial class codAccKindName_Log
    {
        ...
        public string accKindName { get; set; }
        public Nullable<System.DateTime> ackCreateDate { get; set; }
        public string ackStopFlag { get; set; }
        public Nullable<System.DateTime> ackStopDate { get; set; }
    }
}
