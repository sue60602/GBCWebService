...
namespace GBC_WebService.EF
{
    ...
    public partial class tsbPay
    {
        public tsbPay()
        {
            this.tsbPayDtl = new HashSet<tsbPayDtl>();
        }
        ...
        public Nullable<short> tspPayMonth { get; set; }
        public Nullable<short> tspPayDay { get; set; }
        ...
        public virtual ICollection<tsbPayDtl> tsbPayDtl { get; set; }
    }
}
