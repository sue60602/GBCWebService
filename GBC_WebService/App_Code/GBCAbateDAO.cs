...
namespace GBC_WebService
{
    public class GBCAbateDAO : GBCAbate_Interface
    {
        ...
        "delete from GBCAbate where PK_會計年度=@PK_會計年度 and PK_動支編號=@PK_動支編號 and PK_種類=@PK_種類 and PK_次別=@PK_次別 and PK_明細號=@PK_明細號 and PK_沖銷傳票種類=@PK_沖銷傳票種類";
        ...
        public void Delete(GBCAbateVO gBCAbate)
        {
            ...
            com.Parameters.AddWithValue("@PK_沖銷傳票種類", gBCAbate.PK_沖銷傳票種類);
        ...
        public void Insert(GBCAbateVO gBCAbate)
        {
            ...
            com.Parameters.AddWithValue("@F_編修時間", gBCAbate.F_編修時間);
